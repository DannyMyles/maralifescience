...
const Home = () => {
 ...
 // Create an array of expanded states for each item
 const [expandedItems, setExpandedItems] = useState(Array(homedata.length).fill(false));

 const handleButtonClick = (index:number) => {
   // Create a new array and toggle the state of the clicked item
      ...
      <div className="main_image_display">
        ...
        <div className="container">
          <div className="row">
            <div className="column-33">
              <img src="/assets/m2.png" alt="App" />
            </div>
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font">
                  <i className="myco_color">
                    MYCO-DIFF<sup>™</sup>{" "}
                  </i>
                </h1>
                <h3 className="water_mark myco_color">(wp)</h3>
                <span>
              ...
              <div className="description">
                ...
                {!showMore && (
                  <button className="button"  // Create an array of expanded states for each item
                  const [expandedItems, setExpandedItems] = useState(Array(homedata.length).fill(false));
        ...
        <div className="container">
          <div className="row row_reverse">
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font mar_color">
                  MaraShield<sup>™</sup>
                </h1>
                <h3 className="water_mark mar_color">(wp)</h3>
                <span>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font si_color">
                  SIRIZA<sup>™</sup>
                </h1>
                <h3 className="water_mark si_color">(wp)</h3>
                <span>
                  (Beauveria bassiana) <br /> Bioinsecticide
                </span>
              </div>
              <div>
                <span>Insecticide for Pest Management</span>{" "}
              </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font">
                  <i className="ph_color">Pheromone Lures</i>
                </h1>
                <span>(Trap)</span>
              </div>
