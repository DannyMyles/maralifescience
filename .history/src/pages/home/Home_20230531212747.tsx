      ...
      <div className="container" style={{ backgroundColor: '#f1f1f1' }}>
        <div className="row">
          ...
          <div className="column-66">
            ...
            <p>
              <span style={{ fontSize: 24 }}>A revolution in resolution.</span> 
              Discription SIRIZA controls thrips, aphids and whiteflies. It can be integrated into an overall pest management strategy wherver insectcide use is necessary in an IPM progra 
            </p>
            <button className="button" style={{ backgroundColor: 'red' }}>Read More</button>
          </div>
        </div>
