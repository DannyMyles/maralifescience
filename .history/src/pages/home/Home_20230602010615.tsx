        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <h1 className="xlarge-font">MYCO-DIFF <span>(Trichoderma asperellum)
Biological Fungicide</span></h1>
        ...
        <div className="container">
          <div className="row">
            <div className="column-66">
              <h1 className="xlarge-font">MaraShield  <span>(Bacilus subtilis)
Biological Fungicide</span></h1>
              <hr className="under_hr" />
              ...
              <div className="product_description">
                ...
                <h4 className="large-font_def">Biofungicide and Biofertilizer</h4>
              </div>
              <div className="description">
                <div className="large-font">
                  <span>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <h1 className="xlarge-font">SIRIZA  <span>(Beauveria bassiana)
Bioinsecticide</span></h1>
              <hr className="under_hr" />
        ...
        <div className="container">
          <div className="row">
            <div className="column-66">
              <h1 className="xlarge-font">Protac Max <span>(Gliocladium catenulatum)
Insecticide, Thrips / Whiteﬂies </span></h1>
              <hr className="under_hr" />
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <h1 className="xlarge-font">Pheromone Lures <span>(Trap)</span></h1>
              <hr className="under_hr" />
              <div className="product_description">
                <div className="large-font">
                  <span>
