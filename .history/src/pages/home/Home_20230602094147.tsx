      ...
      <div className="main_image_display">
          ...
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font"><i>MYCO-DIFF<sup>™</sup>(wp) </i></h1>
        ...
        <div className="container">
          <div className="row">
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font">MaraShield<sup>™</sup></h1>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font">SIRIZA<sup>™</sup></h1>
        ...
        <div className="container">
          <div className="row">
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font"><i>Protac Max<sup>™</sup></i></h1>
                <span>
