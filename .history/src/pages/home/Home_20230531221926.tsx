...
const Home = () => {
  return (
    <>
      ...
      <div className="main_image_display"></div>
      {/* Clarity Section */}
        ...
        <div className="row">
          <div className="column-66">
            ...
            <p>
              ...
              Discription PROTAC MAX is applied to the soil or folige to prevent,stop,or control pathogenic bacterial or fungal infections in plants and plant roots 
              It defeats pathogens in a varietyof ways to include competition, producing antbiotics parastalizing harmful organisms, inducing systemic or localized resistance in the targeted plant.
            </p>
            <button className="button">Download Application</button>
          </div>
          <div className="column-33">
        ...
        <div className="row">
          ...
          <div className="column-66">
            ...
            <p>
              ...
              Discription Sharp and clear photos with the world's best photo engine, incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquipex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariaturPHEROMONE LURES uses aggregate pheromones to lure and trap insects. They trap sex pheromones and aggrigating pheromones are the most types used.A pheromone - impregnated lure, as the red rubber septa in the picture is encased in a convential trap such as a bottle trap, Delta trap,water- pan trap, or funnel trap.
              Pheromone traps are used both to count insect population by sampling,  and to trap pests such as clothes moths to destroy them.
            </p>
            <button className="button" style={{ backgroundColor: 'red' }}>Read More</button>
          </div>
        </div>
