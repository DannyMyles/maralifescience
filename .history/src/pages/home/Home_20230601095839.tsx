          ...
          <div className="row">
            ...
            <div className="column-66">
              ...
              <div className="product_description">
                <div className="large-font className="icons_desc"">
                  <span>
                    {" "}
                    <IoIosArrowDropright className="icons_desc"/>
                  </span>
              ...
              <div className="description">
                ...
                <p>
                  MYCO-DIFF is a powerful toolfor suppression of
                  root nematodesand fusarium. <br /> It promotes vigorous root
                  development.It is a biological fungicide base on antagonistic{" "}
                  <br />
                  fungiof natural origin of broad spectrum <br /> Its infectious
                  units are spores that control pathogenic fungi. The product
                  can be applied <br /> at any time during crop development; it
                  can be used alone or in combination of foliar <br />{" "}
                  fertilizers and commercial chemical fungicides. MYCODIFF WP
                  can be appliedto at any <br /> time during crop development,
                  mainly before or at the time of planting.
                </p>
                <button className="button">Read more <BsArrowRightCircle size={25} /></button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="column-66">
              ...
              <div className="description">
                ...
                <p>
                  ...
                  <br /> MARASHIELD should be applied prior to desease
                  development, and should be part of a<br />
            ...
            <div className="column-66">
              ...
              <div className="description">
                ...
                <p>
                  ...
                  <br /> It defeats pathogens in a varietyof ways to include
            ...
            <div className="column-66">
              ...
              <div className="description">
                ...
                <p>
                  ...
                  trap, or funnel trap.
                  <br /> Pheromone traps are used both to count insect
                  population by sampling, and to trap <br /> pests such as
                  clothes moths to destroy them.
                </p>
                <button className="button">Read more <BsArrowRightCircle size={25} /></button>
              </div>
            </div>
