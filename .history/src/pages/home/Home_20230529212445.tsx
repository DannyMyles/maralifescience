...
import { homedata, ourBrandData } from "./homeData";
const Home = () => {
  return (
    <>
      <Navbar />
      ...
      <div className="our_brands" style={{ display: "flex", flexWrap: "wrap" }}>
        {ourBrandData &&
          ourBrandData.map((img, index) => (
            <div key={img.id} style={{ width: "50%" }}>
