        ...
        <div className="row">
          <div className="column-66">
            ...
            <p>
              ...
              It defeats pathogens in a varietyof ways to include competition, producing antbiotics parastalizing harmful organisms, inducing systemic or localized resistance in the targete
            </p>
            <button className="button">Download Application</button>
          </div>
          <div className="column-33">
