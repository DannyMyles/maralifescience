      ...
      <div className="main_image_display">
          ...
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font"><i>MYCO-DIFF</i></h1>
                <span>(Trichoderma asperellum) <br /> Biological Fungicide</span>
              </div>
          ...
          <div className="row">
            <div className="column-66">
              <div className="heading_span">
                ...
                <span>(Bacilus subtilis) <br /> Biological Fungicide</span>
              </div>
          ...
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                ...
                <span>(Beauveria bassiana) <br /> Bioinsecticide</span>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font"><i>Protac Max</i></h1>
                <span>
                  (Gliocladium catenulatum) <br /> Insecticide, Thrips / Whiteﬂies{" "}
                </span>
              </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-66">
              <div className="heading_span">
                <h1 className="xlarge-font"><i>Pheromone Lures</i></h1>
                <span>(Trap)</span>
              </div>
              ...
              <div className="description">
                ...
                <p>
                  PHEROMONE&trade; LURES uses aggregate pheromones to lure and trap
