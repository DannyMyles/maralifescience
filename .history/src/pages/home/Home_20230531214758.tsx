        ...
        <div className="row">
          ...
          <div className="column-66">
            ...
            <p>
              ...
              Discription PHEROMONE LURES uses aggregate pheromones to lure and trap insects. They trap sex pheromones and aggrigating pheromones are the most types used.A pheromone - impregnated lure, as the red rubber septa in the picture is e
            </p>
            <button className="button" style={{ backgroundColor: 'red' }}>Read More</button>
          </div>
        </div>
